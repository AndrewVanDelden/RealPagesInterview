...
// verdict on a run that passed --judge, and null otherwise. ScoredRun is the one view of this
...
{
    public sealed record Completed(ProspectCase Case, IngestNotes IngestNotes, AgentRunResult Result, double LatencyMs, ScoredRun ScoredRun, JudgeVerdict? Judgement = null) : RecordRun(Case);
