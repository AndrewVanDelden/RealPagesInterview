...
internal static class FrenchMessageTemplates
{
    public static readonly MessageTemplates Set = new(
        ...
        VoiceCallerOpening: "Ici {0}.",
        VoiceCtaSentence: "Nous vous appelons pour vous aider à {0}.",
        VoiceOptionsSentence: "Appuyez sur {0}.",
        VoiceOptOut: "Pour ne plus recevoir nos appels, appuyez sur 9.",
