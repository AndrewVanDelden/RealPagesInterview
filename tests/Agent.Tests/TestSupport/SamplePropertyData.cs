...
// a starting total monthly price with its as-of date, and one renewal offer for unit A-204.
internal static class SamplePropertyData
{
    public const string TourAvailability = "Tours are available this week, with evening and weekend times.";
